...
function createcountry({ name, flag, code, capital, region,latlng}) {
  ...
  <a href="#" class="btn btn-primary" onclick=(block(${name})) >Click for Weather</a>
 <div id=${name}>   </div>
...
function block(lat,lng,name){
  ...
  var WAPI = `https://api.restcountries.com/v3.1/all/data/2.5/weather?lat=${lat}&lon=${lng}&appid=06e423ec0af839c485470951f60c3f6b`
